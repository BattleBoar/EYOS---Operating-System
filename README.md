...
Проект создаётся энтузиастом/ами.
...
Это свободное программное обеспечение. Вы можете использовать, изучать, распространять его в соответствии с условиями лицензиями MIT License (B.A.D.Boot), Apache License 2.0 (EYrnel), BSD 2-Clause license (SUE). Полный текст LICENSE доступен на страницах компонентах и в интернете.
